...
def predict_num_new_cases(vac_num,population,country):
    if country == "Japan":
        #For Japan
        return str(int(math.exp(-1.92624804*(int(vac_num)/int(population)-1.225269)/0.216455+7.59424472)))
    elif country == "India":
        #For India
        return str(int(math.exp(-0.78281369*(int(vac_num)/int(population)-0.404356)/0.205019+10.54177744)))
    else:
...
print("Predicted result: "+str(predict_num_new_cases(1088236037,1393409033,"Japan")))
